...
bool TCPClient::Open(const char* addr, unsigned short port)
{
    int rc = 0;
    sockaddr_in sin = { 0 };
...
int TCPClient::Send(const unsigned char* data, size_t len)
{
...
void TCPClient::Realloc(size_t new_size/*=1024*/)
{
    new_size += m_size;
...
void TCPClient::debug(const unsigned char* data, size_t len, bool direction)
{
